...
final class EntryTransactionModel extends EntryTransactionEntity implements Model {
  ...
  factory EntryTransactionModel.fromMap(Map<String, dynamic> map) {
    return EntryTransactionModel(
      id: map['id'] as int,
      ...
      historyGroup: HistoriesGroup.of(
        map['history_group'] as String? ?? 'entry',
      ),
    );
  }
  ...
  @override
  EntryTransactionModel copyWith({
    int? id,
    DateTime? createdAt,
    int? createdBy,
    String? note,
