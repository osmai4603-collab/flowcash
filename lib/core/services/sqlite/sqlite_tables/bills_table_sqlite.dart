...
CREATE TABLE IF NOT EXISTS ${tableName} (
        ...
        FOREIGN KEY (${costGoodId}) REFERENCES ${CostGoodBillsTable().tableName} (${CostGoodBillsTable().id}) ON DELETE SET NULL,
        FOREIGN KEY (${treasuryId}) REFERENCES ${PersonsTable().tableName} (${PersonsTable().id}) ON DELETE SET NULL,
        FOREIGN KEY (${journalEntryId}) REFERENCES ${JournalEntriesTable().tableName} (${JournalEntriesTable().id}) ON UPDATE CASCADE ON DELETE CASCADE,
        CHECK (
