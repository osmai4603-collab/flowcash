...
class FinancialTransactionsTableSqlite extends FinancialTransactionsTable implements SqliteTable {
  static final FinancialTransactionsTableSqlite _instance = FinancialTransactionsTableSqlite._internal();

  factory FinancialTransactionsTableSqlite() => _instance;

  FinancialTransactionsTableSqlite._internal() : super.internal();
...
CREATE TABLE IF NOT EXISTS ${tableName} (
        ...
        ${transactionType} TEXT NOT NULL CHECK(${transactionType} IN ('revenues', 'expenses')),
