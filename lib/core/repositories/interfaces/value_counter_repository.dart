...
abstract interface class ValueCounterRepository implements RepositoryDB<ValueCounterEntity> {
  Future<Either<Failure, int>> getNextCounter(int valueGroupId);

  Future<Either<Failure, int>> getNextCounterByGroup(HistoriesGroup historyGroup);
}
