...
abstract interface class HintRepository implements RepositoryDB<HintEntity> {
  ...
  Future<Either<Failure, List<HintEntity>>> whereBelongGroup(
    HistoriesGroup operation,
  );
  Future<Either<Failure, Map<int, HintEntity>>> getWhereHintTypeAsMap(
    Iterable<HintType> hintTypes,
  );
  Future<Either<Failure, HintEntity?>> whereHintTypeAndName(
    HistoriesGroup historyGroup,
    String hintName,
  );
  Future<Either<Failure, HintEntity>> getHintType(
    HistoriesGroup mainAccountId,
    String name,
  );
  Future<Either<Failure, HintEntity>> getHintTypeAndName(
    HistoriesGroup mainAccountId,
    String hintName,
  );
}
