...
abstract interface class SubcategoryLocalDataSource
  ...
  Future<List<SubcategoryUnitEntity>> getUnitsBySubcategoryIds(Iterable<int> ids);
  Future<SubcategoryEntity> insertWithUnits(SubcategoryEntity entity);
  Future<SubcategoryUnitEntity> insertSubcategoryUnit(SubcategoryUnitEntity entity);
  Future<SubcategoryUnitEntity> updateSubcategoryUnit(SubcategoryUnitEntity entity);
