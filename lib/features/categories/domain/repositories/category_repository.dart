...
abstract interface class CategoryRepository implements RepositoryDB<CategoryEntity> {
  Future<Either<Failure, CategoryEntity?>> firstWhereCategoryName(String categoryName);
  ...
  Future<Either<Failure, List<SimpleCategoryEntity>>> whereCategoryNameContains(String categoryName, {int? limit});
