...
class SubcategoryUnitFormPage extends StatelessWidget {
  ...
  const SubcategoryUnitFormPage({super.key, required this.property});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<SubcategoryUnitFormCubit>()..loadUnits(property.id),
      child: _SubcategoryUnitFormView(property: property),
    );
  }
}
...
class _SubcategoryUnitFormView extends StatelessWidget {
  ...
  const _SubcategoryUnitFormView({required this.property});
          ...
          actions: [
            ...
            fluent.FilledButton(
              onPressed: state.selectedUnit == null
                  ? null
                  : () => Navigator.pop(context, state.selectedUnit),
