...
import 'package:flowcash/features/categories/presentation/pages/subcategories/subcategory_unit_form_page.dart';
    ...
    return TableWidget<SubcategoryEntity>(
      ...
      builder: (context, catalog, index) {
        ...
        return [
          ...
          TextWidget(
            text: '$mainCategoryName ${catalog.catalogName}',
            style: style.bodyStrong,
          ),
          buildPropertiesTable(index, context, catalog, state),
          Row(
            ...
            children: [
              ...
              fluent.GestureDetector(
                ...
                onTap: () => _onDeleteSubcategory(context, catalog),
              ),
            ],
          ),
        ];
      ...
      if (subcategoryUnit != null && context.mounted) {
        bloc.add(
          AddSubcategoryUnitEvent(
            catalogId: subcategoryUnit.subcategoryId,
            unitId: subcategoryUnit.unitId,
            propertyId: subcategoryUnit.propertyId,
          ),
        );
      }
    }
