...
abstract interface class MainAccountRepository implements RepositoryDB<MainAccountEntity> {
  Future<Either<Failure, List<MainAccountEntity>>> whereAccountGroup(MainAccountGroup accountType, int periodId);
  Future<Either<Failure, List<MainAccountEntity>>> whereMainAccountType(MainAccountType belongGroup, int warehouseId);
  Future<Either<Failure, List<MainAccountEntity>>> whereAccountType(Iterable<MainAccountType> belongGroup, int warehouseId);
  Future<Either<Failure, List<MainAccountEntity>>> whereAccountsGroups(Iterable<MainAccountGroup> types, int warehouseId);
