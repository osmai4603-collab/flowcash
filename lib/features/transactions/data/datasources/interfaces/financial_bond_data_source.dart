...
abstract interface class FinancialBondDataSource implements AppDataSource<int, FinancialBondEntity, Map<String, dynamic>> {
  @override
  Future<List<FinancialBondEntity>> get({Iterable<int>? ids, HistoriesGroup? historyGroup});
}
