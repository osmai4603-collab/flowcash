...
class FinancialTransactionsBloc
    extends Bloc<FinancialTransactionsEvent, FinancialTransactionsState> {
  ...
  FinancialTransactionsBloc({
    ...
    required InsertFinancialTransactionUseCase
    insertFinancialTransactionUseCase,
    required UpdateFinancialTransactionUseCase
    updateFinancialTransactionUseCase,
    required DeleteFinancialTransactionUseCase
  ...
  Future<void> _onLoadTransactions(
    LoadFinancialTransactionsEvent event,
    EmitFn emit,
  ) async {
  ...
  Future<void> _onAddTransaction(
    AddFinancialTransactionEvent event,
    EmitFn emit,
  ) async {
    emit(state.toLoading());
  ...
  void _onSelectTransaction(
    SelectFinancialTransactionEvent event,
    EmitFn emit,
  ) {
