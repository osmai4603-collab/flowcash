              ...
              child: Row(
                children: [
                  ...
                  SegmentedButton<bool>(
                    segments: const [
                      ButtonSegment(value: false, label: Text('المشتريات'), icon: Icon(Icons.shopping_cart)),
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text(_isReturnFilter ? 'مرتجع مشتريات جديد' : 'فاتورة مشتريات جديدة'),
                  ),
                ],
              ),
            ),
    ...
    showDialog(
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          title: Text(_isReturnFilter ? 'إضافة مرتجع مشتريات' : 'إضافة فاتورة مشتريات جديدة'),
